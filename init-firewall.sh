...
# Allowed domains: Claude Code + npm + Python/ML ecosystem
for domain in \
    "api.anthropic.com" \
    "sentry.io" \
...
if curl --connect-timeout 5 https://example.com >/dev/null 2>&1; then
    ...
    echo "PASS: unable to reach https://example.com"
fi
...
if ! curl --connect-timeout 5 https://pypi.org/simple/ >/dev/null 2>&1; then
    ...
    echo "PASS: able to reach https://pypi.org"
fi
